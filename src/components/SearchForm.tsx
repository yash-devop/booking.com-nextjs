...
// below Zod validation => for Form Correct Inputs.

/*
    if want object then do : z.object({}) in zod
*/
export const formSchema = z.object({
    location: z.string().min(2 , "Must be 2 characters or more.").max(50),
    dates: z.object({
        from: z.date({required_error:"Please set a check-in date"}),
        to: z.date({required_error:"Please set a check-out date"})
    }),
    adults: z.string().min(1 ,{message:"Max 12 adults Occupancy"}),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="London, UK" {...field} className="bg-white border-[#adadad]"/>
                </FormControl>
              </FormItem>
            )}
          />
              ...
              <FormItem className="flex flex-col">
                ...
                <Popover>
                  <PopoverTrigger asChild >
                    <FormControl className="bg-white border-[#adadad]">
                      <Button
                        id="date"
                        name="dates"
                        variant={"outline"}
                  ...
                  <PopoverContent className="w-auto p-0 bg-white border-[#adadad]" align="start">
                    <Calendar
                      initialFocus
                      mode="range"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormMessage />
                  <FormControl>
                    <Input type="number" placeholder="Adults" {...field} className="bg-white border-[#adadad]"/>
                  </FormControl>
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormMessage />
                  <FormControl>
                    <Input type="number" placeholder="Children" {...field}  className="bg-white border-[#adadad]"/>
                  </FormControl>
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormMessage />
                  <FormControl>
                    <Input type="number" placeholder="rooms" {...field} className="border-[#adadad] bg-white" />
                  </FormControl>
                </FormItem>
              )}
            />
